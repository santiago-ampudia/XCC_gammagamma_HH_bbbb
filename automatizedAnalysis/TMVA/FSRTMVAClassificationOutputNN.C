...
int FSRTMVAClassificationOutputNN( TString myMethodList = "", string rtdCut = "invalid", string preselection = "", string varVersion = "invalid", string sampleName = "")
{
   ...
   string inputSText = "analysis/outputTreeSNNESpreadDurham"+rtdCut+preselection+"Train"+sampleName+".root";
   string inputBqqText = "analysis/outputTreeBqqNNESpreadDurham"+rtdCut+preselection+"Train"+sampleName+".root";
