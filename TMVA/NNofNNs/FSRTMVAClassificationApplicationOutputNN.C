 ...
 void FSRTMVAClassificationApplicationOutputNNHelper( TString myMethodList, vector<double>& NNOutput, int& sizeTree, int nbin, TH1F& histOutput, string inputMethod, TString NNVars, int topology)
 {
    ...
    //
    TFile* inputS = new TFile("outputTreeSNNTest.root");
    TFile* inputBqq = new TFile("outputTreeBqqNNTest.root");
    TFile* inputBttbar = new TFile("outputTreeBttbarNNTest.root");
    TFile* inputBZZ = new TFile("outputTreeBZZNNTest.root");
    TFile* inputBWW = new TFile("outputTreeBWWNNTest.root");
    ...
    sw.Start();
	    ...
	    TString dir;
	    dir    = "datasetOutputNN" + NNVars + "/weights/";
    ...
    TFile *target  = new TFile( "TMVAppOutputNN.root","RECREATE" );
...
void checkSigmaOGStyle(double bottomHistLimit, double topHistLimit, int nBack, double weightHH, double weightBack)
 ...
 void FSRTMVAClassificationApplicationOutputNN()
 {
 	...
 	TFile* inputTestWW = new TFile(inputTestWWText.c_str());
    	...
    	TFile* inputTrainHHNN = new TFile("outputTreeSNNTrain.root");
    	TTree* theTreeTrainHHNN = (TTree*)inputTrainHHNN->Get("TreeSNNTrain");
 	TFile* inputTestHHNN = new TFile("outputTreeSNNTest.root");
    	...
    	TFile* inputTrainqqNN = new TFile("outputTreeBqqNNTrain.root");
    	TTree* theTreeTrainqqNN = (TTree*)inputTrainqqNN->Get("TreeBqqNNTrain");
 	TFile* inputTestqqNN = new TFile("outputTreeBqqNNTest.root");
    	...
    	TFile* inputTrainttbarNN = new TFile("outputTreeBttbarNNTrain.root");
    	TTree* theTreeTrainttbarNN = (TTree*)inputTrainttbarNN->Get("TreeBttbarNNTrain");
 	TFile* inputTestttbarNN = new TFile("outputTreeBttbarNNTest.root");
    	...
    	TFile* inputTrainZZNN = new TFile("outputTreeBZZNNTrain.root");
    	TTree* theTreeTrainZZNN = (TTree*)inputTrainZZNN->Get("TreeBZZNNTrain");
 	TFile* inputTestZZNN = new TFile("outputTreeBZZNNTest.root");
    	...
    	TFile* inputTrainWWNN = new TFile("outputTreeBWWNNTrain.root");
    	TTree* theTreeTrainWWNN = (TTree*)inputTrainWWNN->Get("TreeBWWNNTrain");
 	TFile* inputTestWWNN = new TFile("outputTreeBWWNNTest.root");
 	...
 	//////////
 	FSRTMVAClassificationApplicationOutputNNHelper("", NNOutput, sizeHH, nbinNN, *histNNHH, method, variables, 0);
 	FSRTMVAClassificationApplicationOutputNNHelper("", NNOutput, sizeqq, nbinNN, *histNNBqq, method, variables, 1);
 	FSRTMVAClassificationApplicationOutputNNHelper("", NNOutput, sizettbar, nbinNN, *histNNBttbar, method, variables, 2);
 	FSRTMVAClassificationApplicationOutputNNHelper("", NNOutput, sizeZZ, nbinNN, *histNNBZZ, method, variables, 3);
 	FSRTMVAClassificationApplicationOutputNNHelper("", NNOutput, sizeWW, nbinNN, *histNNBWW, method, variables, 4);
 	//////////////
 	...
 	//cout<<"Cross-section and error for the output of "<<method<<"qq and "<<method<<"ttbar combined applied to HH, qq, and ttbar: "<<endl;
