...
int FSRTMVAClassificationOutputNN( TString myMethodList = "" )
{
   ...
   TFile* inputS = new TFile("outputTreeSNNTrain.root");
   TFile* inputBqq = new TFile("outputTreeBqqNNTrain.root");
   TFile* inputBttbar = new TFile("outputTreeBttbarNNTrain.root");
   TFile* inputBZZ = new TFile("outputTreeBZZNNTrain.root");
   TFile* inputBWW = new TFile("outputTreeBWWNNTrain.root");
   ...
   TTree *signalTree = (TTree*)inputS->Get("TreeSNNTrain");
   TTree *backgroundqq = (TTree*)inputBqq->Get("TreeBqqNNTrain");
   ...
   TString outfileName( "TMVAOutputNN.root" );
   ...
   dataloader=new TMVA::DataLoader("datasetOutputNNqqttbarZZWW");
   ...
   dataloader->AddBackgroundTree( backgroundqq, backgroundqqWeight );
   ...
   std::cout << "==> TMVAClassificationOutputNN is done!" << std::endl;
...
int main( int argc, char** argv )
{
   ...
   return FSRTMVAClassificationOutputNN(methodList);
}
