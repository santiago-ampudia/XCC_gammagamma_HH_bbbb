...
int FSRTMVAClassificationHHbbbb( TString myMethodList = "" )
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start TMVAClassificationHHbbbb" << std::endl;
   ...
   string inputBZZText = "outputTreeBZZHHbbbbESpreadDurham"+rtdCut+"Train.root";
   string inputBWWText = "outputTreeBWWHHbbbbESpreadDurham"+rtdCut+"Train.root";
   ...
   if(back == "qq")
   {
   	background = (TTree*)inputBqq->Get("TreeBqqTrain");
   	backgroundSize = background->GetEntries();
   }
   else if(back == "ttbar")
   {
   	background = (TTree*)inputBtt->Get("TreeBttTrain");
   	backgroundSize = background->GetEntries();
   }
   else if(back == "ZZ")
   {
   	background = (TTree*)inputBZZ->Get("TreeBZZTrain");
   	backgroundSize = background->GetEntries();
   }
   else if(back == "WW")
   {
   ...
   else if(varVersion == "All2V")
   {
   	...
   	dataloader->AddVariable( "sphericity", 'F' );
   	dataloader->AddVariable( "sumPt", 'F' );
   	dataloader->AddVariable( "nParticles", 'F' );
   	dataloader->AddVariable( "minConstSize", 'F' );
   }
